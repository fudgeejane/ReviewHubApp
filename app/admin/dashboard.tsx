...
import ModalAdminCourse from '../components/ModalAdminCourse';
...
export default function AdminDashboard() {
  ...
  const handleAddCourse = (courseData: { courseCode: string; courseDescription: string; instructor: string }) => {
    ...
    <ScrollView style={styles.container}>
      ...
      >
        <View style={styles.activeSessionBadge}>
          <Text style={styles.activeSessionText}>Admin</Text>
        </View>
        <Text style={styles.welcomeTitle}>Welcome back, Admin SAI!</Text>
      ...
      <View style={styles.sectionContainer}>
        <View style={styles.contentHeader}>
          <Text style={styles.contentTitle}>All Courses</Text>
          <TouchableOpacity 
